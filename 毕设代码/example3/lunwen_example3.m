...
[X,Y,Z]=griddata(xc,yc, un(:,(floor(tend/tau))),linspace(min(xc),max(xc))',linspace(min(yc),max(yc)),'v4');
surf(X,Y,Z);
shading interp;
xlabel('x1');
ylabel('x2');
...
[X,Y,Z]=griddata(xc,yc, mun(:,(floor(tend/tau))),linspace(min(xc),max(xc))',linspace(min(yc),max(yc)),'v4');
surf(X,Y,Z);
shading interp;
xlabel('x1');
ylabel('x2');
...
[X,Y,Z]=griddata(xc,yc, unreal(:,(floor(tend/tau))),linspace(min(xc),max(xc))',linspace(min(yc),max(yc)),'v4');
surf(X,Y,Z);
shading interp;
xlabel('x1');
ylabel('x2');
...
[X,Y,Z]=griddata(xc,yc, munreal(:,(floor(tend/tau))),linspace(min(xc),max(xc))',linspace(min(yc),max(yc)),'v4');
surf(X,Y,Z);
shading interp;
xlabel('x1');
ylabel('x2');
